...
namespace StudioCore.Editor
{
    public class EditorDecorations
    {
        ...
        private static bool PropertyRowRefsContextItems(List<string> reftypes, dynamic oldval, ref object newval)
        { 
            // Add Goto statements
        ...
        private static bool PropertyRowEnumContextItems(ParamEnum en, object oldval, ref object newval)
        {
            try
            {
