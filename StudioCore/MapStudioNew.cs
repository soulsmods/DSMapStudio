...
namespace StudioCore
{
    ...
    {
        public static MapStudioNew MainInstance;

        public static string ProgramVersion = "version 1.03";
        private static string _programTitle = $"Dark Souls Map Studio {ProgramVersion}";
