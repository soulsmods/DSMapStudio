...
namespace StudioCore
{
    public struct Transform
    {
        ...
        public Matrix4x4 WorldMatrix => OverrideMatrixWorld != Matrix4x4.Identity ? OverrideMatrixWorld : ScaleMatrix * RotationMatrix * TranslationMatrix;
        ...
        public Matrix4x4 CameraViewMatrixLH { get
            {
                var look = Vector3.Normalize(Look - Position);
                var right = Vector3.Normalize(Vector3.Cross(Up, look));
