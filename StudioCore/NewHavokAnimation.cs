        ...
        private void UpdateCurrentRootMotion()
        {
            if (RootMotionFrames != null)
            {
                ...
                if (CurrentFrame != frameFloor)
                {
                    ...
                    currentRootMotionVector4.X = Utils.Lerp(currentRootMotionVector4.X, nextFrameRootMotion.X, frameMod);
                    currentRootMotionVector4.Y = Utils.Lerp(currentRootMotionVector4.Y, nextFrameRootMotion.Y, frameMod);
                    currentRootMotionVector4.Z = Utils.Lerp(currentRootMotionVector4.Z, nextFrameRootMotion.Z, frameMod);
                    currentRootMotionVector4.W = Utils.Lerp(currentRootMotionVector4.W, nextFrameRootMotion.W, frameMod);
                }
            }
            else
            {
